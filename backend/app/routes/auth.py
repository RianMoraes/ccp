...
# A chave DEVE vir da variável de ambiente SECRET_KEY em produção.
# O valor abaixo só é usado como fallback para desenvolvimento local.
SECRET_KEY = os.getenv("SECRET_KEY", "SUPER_SECRET_KEY_FOR_CCP_INDUSTRIAL_DEV_ONLY")
ALGORITHM = "HS256"
